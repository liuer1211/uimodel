...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			_this.ensureBtn = _this.mobileSelect.querySelector('.seEnsure');
			_this.cancelBtn = _this.mobileSelect.querySelector('.seCancel');
			_this.grayLayer = _this.mobileSelect.querySelector('.grayLayer');
			_this.popUp = _this.mobileSelect.querySelector('.se-content');
		...
		setTitle: function(string){
			...
			_this.mobileSelect.querySelector('.seTitle').innerHTML = _this.titleText;
		},
		...
		setStyle: function(config){
			...
			if(config.titleColor){
				_this.seTitle = _this.mobileSelect.querySelector('.seTitle');
				_this.seTitle.style.color = config.titleColor;
			}
			if(config.textColor){
				_this.sePanel = _this.mobileSelect.querySelector('.sePanel');
				_this.sePanel.style.color = config.textColor;
			}
			...
			if(config.bgColor){
				...
				_this.sePanel.style.backgroundColor = config.bgColor;
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText){
			...
			_this.mobileSelect.innerHTML =
		        ...
		        '<div class="se-content">'+
		            '<div class="btnBar">'+
		                '<div class="fixWidth">'+
		                    '<div class="seCancel">'+ cancelText +'</div>'+
		                    '<div class="seTitle"></div>'+
		                    '<div class="seEnsure">'+ ensureText +'</div>'+
		                '</div>'+
		            '</div>'+
		            '<div class="sePanel">'+
		                '<div class="fixWidth">'+
